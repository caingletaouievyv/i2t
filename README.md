...
Live Demo / API
	• Frontend: https://i2t.netlify.app/
	• Backend: https://i2t-27gz.onrender.com

Repository 
	• caingletaouievyv/i2t
	• Frontend: /i2t-Client
	• Backend: /i2t-Api 
...
Authentication
	...
	• Token Refresh Handling Strategy: (Manual, currently not auto-refresh)
...
Database & Seeding
	• Current Database: InMemory (no persistence).
...
Frontend
	...
	• Coverage:
		...
		○ Context menu (copy, re-OCR)
		○ Protected routes
Backend
	• Framework: xUnit
	• Tests for:
		○ OCR service with sample images
		○ AuthController (valid/invalid login)
		○ Hunspell dictionary corrections

Deployment
	• Frontend: Render (or Netlify/Vercel)
	• Backend: Render (or Azure App Service)
	• CI/CD: GitHub Actions (build + deploy)
	• Secrets/Env Vars: Stored in .env (frontend) & Render dashboard (backend)
...
<img width="567" height="2835" alt="image" src="https://github.com/user-attachments/assets/28ec0d4d-2cd7-4001-b44b-2dcd18b5fe47" />
